...
class QuizTwoViewController: UIViewController {
    ...
    func nextQuestion() {
        if questionCounter < 10 {
            questionLabel.text = questions.questionList2[questionCounter].question
            processLabel.text = "\(questionCounter + 1)/10"
    ...
    func checkAnswer() {
        ...
        let correctAnswer = questions.questionList2[questionCounter].answer
